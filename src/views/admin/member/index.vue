    ...
    <template #wrapper>
      <el-card class="box-card">
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
          ...
          <el-form-item label="会员名称" prop="username"><el-input
...
<script>
import { addMember, delMember, getMember, listMember, updateMember } from '@/api/admin/member'
...
export default {
  ...
  data() {
    return {
      ...
      // 表单校验
      rules: { mobile: [{ required: true, message: '手机号不能为空', trigger: 'blur' }],
